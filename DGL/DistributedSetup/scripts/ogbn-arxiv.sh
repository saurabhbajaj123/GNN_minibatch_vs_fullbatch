...
--num_samplers 0 \
--num_servers 1 \
--part_config /home/ubuntu/gnn_mini_vs_full/GNN_minibatch_vs_fullbatch/PipeGCN/partitions/ogbn-arxiv-1-metis-vol-trans/ogbn-arxiv-1-metis-vol-trans.json \
--ip_config ip_config.txt \
"/home/ubuntu/gnn_mini_vs_full/GNNEnv/bin/python3 node_classification.py --dataset ogbn-arxiv --graph_name ogbn-arxiv-1-metis-vol-trans --ip_config ip_config.txt --num_epochs 100 --batch_size 1000 --num_gpus 1 --num_hidden 16 --num_layers 2 --fan_out 5,5"
