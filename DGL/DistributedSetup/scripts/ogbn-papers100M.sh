...
--num_samplers 0 \
--num_servers 1 \
--part_config /home/ubuntu/gnn_mini_vs_full/GNN_minibatch_vs_fullbatch/DGL/DistributedSetup/partitions/ogbn-papers100m_frac_100.0_hops_2_subgraph-3-metis-vol-trans/ogbn-papers100m_frac_100.0_hops_2_subgraph-3-metis-vol-trans.json \
--ip_config ip_config.txt \
"/home/ubuntu/gnn_mini_vs_full/GNNEnv/bin/python3 node_classification.py --dataset ogbn-papers100m --graph_name ogbn-papers100m_frac_100.0_hops_2_subgraph-3-metis-vol-trans --ip_config ip_config.txt --num_epochs 20 --batch_size 1024 --num_gpus 4 --num_hidden 128 --num_layers 2 --fan_out 5,5 --eval_every 10"
