...
--num_samplers 0 \
--num_servers 1 \
--part_config /work/sbajaj_umass_edu/GNN_minibatch_vs_fullbatch/DGL/DistributedSetup/partitions/ogbn-products_1_parts/ogbn-products.json \
--ip_config ip_config.txt \
"/work/sbajaj_umass_edu/GNNEnv/bin/python3 node_classification.py --graph_name ogbn-products --ip_config ip_config.txt --num_epochs 10 --batch_size 1000 --num_gpus 2 --num_hidden 16 --num_layers 2 --fan_out 5,5"
