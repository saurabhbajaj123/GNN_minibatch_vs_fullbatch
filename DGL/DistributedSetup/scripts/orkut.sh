...
--num_samplers 0 \
--num_servers 1 \
--part_config /work/sbajaj_umass_edu/GNN_minibatch_vs_fullbatch/PipeGCN_GAT_GCN/partitions/orkut-2-metis-vol-trans/orkut-2-metis-vol-trans.json \
--ip_config ip_config.txt \
"/work/sbajaj_umass_edu/GNNEnv/bin/python3 node_classification.py --dataset orkut --graph_name orkut-2-metis-vol-trans --ip_config ip_config.txt --num_epochs 5 --batch_size 1024 --num_gpus 4 --num_hidden 128 --num_layers 2 --fan_out 5,5 --eval_every 10 --lr 0.003"
