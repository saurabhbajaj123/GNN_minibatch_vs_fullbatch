...
class GraphConvNet(nn.Module):
    ...
    def __init__(self, in_channels=3, hidden_channels=64, out_channels=6, num_layers=6):
        ...
        self.gcn.append(GraphConv(in_channels, out_channels, allow_zero_in_degree=True))
