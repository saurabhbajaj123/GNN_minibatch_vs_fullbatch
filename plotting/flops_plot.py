...
import numpy as np
import math
# pubmed = [28.05201573, 26.67826969, 27.30751238, 26.35074063, 26.81393406, 26.89083683, 25.97989312]
# arxiv = [9.565217407, 9.570827559, 9.565364488, 9.56910681, 9.565634008, 9.536748617, 9.518886808]
# reddit = [139.0289477,140.0543792,141.0291504,142.6297816, 146.7241162, 137.3080989, 136.3906967]
# products = [6.902931559,6.903101025,6.901929131,6.902551435, 6.904224292, 6.900040515, 6.90648476]
# papers = [788.2223972, 788.4937046, 788.2039499, 788.1354759, 788.207963, 788.1803904, 788.195471]
...
# pubmed  = [math.log(x) for x in pubmed]
# arxiv  = [math.log(x) for x in arxiv]
# reddit  = [math.log(x) for x in reddit]
# products  = [math.log(x) for x in products]
# papers  = [math.log(x) for x in papers]

n_gpus = [1,2,3,4,8,16,32]
# n_gpus = [np.log(x) for x in n_gpus]
